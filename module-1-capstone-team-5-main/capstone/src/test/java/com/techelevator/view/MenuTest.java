...
public class MenuTest {
    ...
    @Test
    public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice_but_they_strings() {
        String[] options = new String[]{"Three", "Blind", "Mice"};
        Menu menu = getMenuForTesting();

        menu.getChoiceFromStrings(options);
    ...
    @Test
    public void hides_secret_menu() {
        String[] options = new String[]{"Three", "Blind", "Mice", "Sales Report"};
        Menu menu = getMenuForTesting();
